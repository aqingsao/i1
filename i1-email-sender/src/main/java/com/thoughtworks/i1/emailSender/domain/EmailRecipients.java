...
public abstract class EmailRecipients {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "emailRecipientsSeq")
    @SequenceGenerator(initialValue = 1, name = "emailRecipientsSeq", sequenceName = "EMAIL_RECIPIENTS_SEQUENCE")
    protected long id;
